...
- Paste or drop images, videos, and files into new messages and replies. Attachments go after the message; inline placement between paragraphs is not supported yet.
- Continue work in another agent with a prepared handoff prompt.
- Optionally cache mail on this computer for faster reopening. Settings → Mail controls storage limits, retention, and preloading.
...
- A HEY account and [HEY CLI](https://github.com/basecamp/hey-cli) 1.7.0 or newer, installed and signed in (`hey upgrade` to update).
