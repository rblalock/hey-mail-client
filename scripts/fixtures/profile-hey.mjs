...
if (root === "--version") { console.log("hey 1.7.0"); process.exit(0); }
...
else if (root === "search") { if (action === "slow") await new Promise((resolve) => setTimeout(resolve, 600)); data = action === "shared" ? [{ ...posting, topic_id: 777 }] : [posting]; }
...
else if (root === "thread") data = [{ id: account + 3, body: `Synthetic mail body for ${account}`, creator: { name: "Fixture" } }];
